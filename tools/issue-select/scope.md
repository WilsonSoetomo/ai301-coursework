...
I have used Python and Git in class and on small projects, and I want to get better at reading existing code, making small fixes, and working through project review feedback. I prefer issues that are clearly scoped, low-risk, and easy to test, and I would rather avoid broad redesigns, deep framework changes, or issues that require a lot of unclear discussion before coding.